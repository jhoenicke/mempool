...
var config = [
    {"name":"BTC",
     "classname": "btc",
     "title":"Bitcoin Core 23.0.  Huge mempool limit and no timeout, to prevent any transactions to be dropped.",
   ...
   "#000000"
    ...
    {"name":"BTC (default mempool)",
     "classname": "btc",
     "title":"Bitcoin Core 0.21.2 with default mempool settings (300 MB + 14 days timeout).",
   ...
   "#000000"
    ...
    {"name":"ETH",
     "classname":"eth",
     "title":"geth 1.10.21 with 150k slots",
...
//   "#800080", "#ac00ac", "#d800d8", "#ff00ff", "#ff2cff", "#ff58ff", "#ff80ff",
   "#000000"
    ...
    {"name":"DASH",
     "classname": "dash",
     "title":"Dash Core v0.17.0.3 with default memory limit",
