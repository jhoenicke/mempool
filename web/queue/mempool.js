...
//   "#800080", "#ac00ac", "#d800d8", "#ff00ff", "#ff2cff", "#ff58ff", "#ff80ff",
   "#000000"
    ...
    {"name":"BTC (default mempool)",
     "classname": "btc",
     "title":"Bitcoin Core 25.0.0 with default mempool settings (300 MB + 14 days timeout).",
...
//   "#800080", "#ac00ac", "#d800d8", "#ff00ff", "#ff2cff", "#ff58ff", "#ff80ff",
   "#000000"
    ...
    {"name":"ETH",
     "classname":"eth",
     "donatebutton": true,
     "title":"geth 1.13.4 with 150k slots",
...
//   "#800080", "#ac00ac", "#d800d8", "#ff00ff", "#ff2cff", "#ff58ff", "#ff80ff",
   "#000000"
    ...
    {"name":"DASH",
     "classname": "dash",
     "donatebutton": true,
     "title":"Dash Core v19.2.0 with default memory limit",
