...
var config = [
    {"name":"BTC",
     "classname": "btc",
     "donatebutton": true,
     "title":"Bitcoin Core 27.1.  Huge mempool limit and no timeout, to prevent any transactions to be dropped.",
...
//   "#800080", "#ac00ac", "#d800d8", "#ff00ff", "#ff2cff", "#ff58ff", "#ff80ff",
   "#000000"
    ...
    /*{"name":"ETH-backup",
     "classname":"eth",
     "title":"geth 1.13.15 with 150k slots",
   ...
   "#000000"
    ...
    {"name":"BCH",
     "classname": "bch",
     "donatebutton": true,
     "title":"Bitcoin Cash - BCHN 27.1.0.",
...
//   "#800080", "#ac00ac", "#d800d8", "#ff00ff", "#ff2cff", "#ff58ff", "#ff80ff",
   "#000000"
    ...
    {"name":"DASH",
     "classname": "dash",
     "donatebutton": true,
     "title":"Dash Core v21.0.0 with default memory limit",
